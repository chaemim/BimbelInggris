  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/beranda">
        ...
        <div class="sidebar-brand-text mx-2">English Course & Bimbel</div>
      </a>
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <div class="input-group-append">
                <h4>English Course & Bimbel di Learning Education Center (SIPSLEC)</h4>
              </div>
            </div>
          </form>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray600 small">{{ Auth::user()->name  }}</span>
                <img class="img-profile roundedcircle" src="{{ asset('asset/img/avatar2.png')}}">
              </a>
